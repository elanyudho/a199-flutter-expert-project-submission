...
void main() {
  const API_KEY = 'api_key=6003f735cfef355d7374d99d3643fb54';
  ...
  group('get Popular Tv Series', () {
    final tvSeriesList =
        TvSeriesResponse.fromJson(json.decode(readJson('dummy_data/tv_series.json')))
            .results;
    ...
    test('should return list of tv series Model when the response code is 200',
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/tv_series.json'), 200));
      // act
