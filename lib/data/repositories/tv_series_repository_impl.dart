...
import '../models/watch_list_table.dart';
...
class TvSeriesRepositoryImpl implements TvSeriesRepository {
  ...
  @override
  Future<Either<Failure, List<TvSeries>>> getRecommendationTvSeries(int id) async {
    try {
  ...
  Future<Either<Failure, String>> removeTvSeriesWatchlist(TvSeriesDetail tvSeries) async {
    try {
      final result =
          await localDataSource.removeWatchlistTvSeries(WatchListTable.fromTvSeriesEntity(tvSeries));
      return Right(result);
  ...
  Future<Either<Failure, String>> saveTvSeriesWatchlist(TvSeriesDetail tvSeries) async {
    try {
      final result =
          await localDataSource.insertWatchlistTvSeries(WatchListTable.fromTvSeriesEntity(tvSeries));
      return Right(result);
    } on DatabaseException catch (e) {
      return Left(DatabaseFailure(e.message));
    } catch (e) {
