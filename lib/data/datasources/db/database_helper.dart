...
class DatabaseHelper {
  ...
  Future<int> insertWatchlistMovie(WatchListTable movie) async {
    final db = await database;
    return await db!.insert(_tblWatchlistMovie, movie.toJson());
  }

  Future<int> removeWatchlistMovie(WatchListTable movie) async {
    final db = await database;
  ...
  Future<int> insertWatchlistTvSeries(WatchListTable tvSeries) async {
    final db = await database;
    return await db!.insert(_tblWatchlistTvSeries, tvSeries.toJson());
  }

  Future<int> removeWatchlistTvSeries(WatchListTable tvSeries) async {
    final db = await database;
    return await db!.delete(
